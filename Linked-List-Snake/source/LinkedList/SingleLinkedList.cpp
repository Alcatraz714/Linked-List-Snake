...
namespace LinkedList
{
	...
	// looping to get the direction of all nodes reversed
	...
	// we switch the and reverse a body part's direction
	...
	// we get reverse direction for any body part / entity woth direction
